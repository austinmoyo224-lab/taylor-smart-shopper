  ...
  return (
    <div className="flex-1 overflow-y-auto px-8 py-10">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
        <StatCard label="Organisations" value={data?.organisations} icon={Building2} loading={isLoading} />
        ...
        <StatCard label="Conversations" value={data?.conversations} icon={MessagesSquare} loading={isLoading} />
      ...
      <p className="mt-10 max-w-xl text-xs leading-relaxed text-muted">
        Numbers span every tenant on Taylor Intelligence. Use the sidebar to
        drill into organisations, stores, users and the audit log.
      </p>
    </div>
  );
}
